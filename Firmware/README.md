...
ADC выполняет измерения только вне активного BLE-соединения. Одновременная
работа ADC clock/conversion и радио на этой ревизии PHY6252 теряет ATT-ответы;
на время мобильной сессии validity измерений поэтому честно сбрасывается.
