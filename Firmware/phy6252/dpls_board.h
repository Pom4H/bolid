 ...
 * single light guide instead). These are the PB-03F-Kit's own LEDs; the
 * interactive pin/mode map is generated by tools/generate_behavior_sim.py and
 * attached to GitHub releases, rather than committed as built HTML:
