...
/* Disconnected/advertising operation samples only +1 and reserve. A connected
 * operator session enables all four channels and gates one conversion into the
 * quiet interval immediately after each BLE connection event. */
