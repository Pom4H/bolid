...
/* PHY62XX SDK 3.1.2 определяет g_chipMAddr в flash.c, но не объявляет extern
 * в flash.h. Используем vendor decoder/state и не читаем произвольные raw
 * flash sectors из раннего boot. */
