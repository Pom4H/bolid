...
def main() -> None:
    ...
    require(app, "DPLS_RX_SETTLE_MS 700u", APP)
    ...
    require(startup, "#define BLE_MAX_ALLOW_PKT_PER_EVENT_TX 1", MAIN)
    require(startup, "#define BLE_MAX_ALLOW_PKT_PER_EVENT_RX 1", MAIN)
    ...
    require(startup, "#define LARGE_HEAP_SIZE                (23u * 128u)", MAIN)
